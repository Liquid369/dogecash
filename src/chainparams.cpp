...
static Checkpoints::MapCheckpoints mapCheckpoints = 
	...
	(0, uint256("00000c961c2148bda4b298f32636ad8ac5faa9c7723fa5597e14530a847c1924"));
...
public:
	...
	//vTreasuryRewardAddress="DKv8dUifgBKkWM1nwjad7yNasQ41yA9ntR";
      ...
      //  nSupplyBeforeFakeSerial = 4131563 * COIN;   // zerocoin supply at block nFakeSerialBlockheightEnd
		...
		genesis.nNonce = 1667153; 
        hashGenesisBlock = genesis.GetHash();
        //MineGenesis(genesis);
        //debug code
	//    std::cout << "genesisinfo \n " << genesis.ToString();
        assert(hashGenesisBlock == uint256("00000c961c2148bda4b298f32636ad8ac5faa9c7723fa5597e14530a847c1924")); 
        assert(genesis.hashMerkleRoot == uint256("179feef6c4edaaa3886e37a8367b7a0365d179dca666272b9961cd2d9fc07201")); 
	...
	base58Prefixes[EXT_SECRET_KEY] = list_of(0x02)(0x21)(0x31)(0x2B).convert_to_container<std::vector<unsigned char> >();
        ...
        nBudgetCycleBlocks = 100; //!< Amount of blocks in a months period of time (using 1 minutes per) = (60*24*30)
